...
/**
 * shash_table_set - Adds an element 2 a sorted hash table.
 * @ht: Ptr 2 the sorted hash table.
 * @key: Key 2 add - cannot be an empty string.
 ...
 * @ht: Ptr 2 the sorted hash table to print.
 */
